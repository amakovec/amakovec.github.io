// Based on https://jekyllcodex.org/without-plugin/lightbox/
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    images.forEach(image => {
        ...
        if(image_src) {
            if(is_imagelink(image_src) && !image.classList.contains('no-lightbox')) {
    ...
    var images = document.querySelectorAll('img.lightbox-image');
    images.forEach(image => {
